...
if (!empty($camaba)) {
    $data_prestasi = $modelPrestasi->getPrestasi($sesi['id']);
    $data_prodi = $modelProdi->getProdiCamaba($sesi['id']);
} else {
    header('location:index.php?camaba=tambah_data_diri');
}
            ...
            <tbody>
                ...
                <tr>
                    <th scope="col" colspan="2">Data Diri&nbsp;
                        <a href="index.php?camaba=maba_edit#data_diri" class="text-secondary">
                ...
                <tr>
                    <th scope="col" colspan="2">Data Prodi Pilihan&nbsp;
                        <a href="index.php?camaba=edit_pilihan_fakultas" class="text-secondary">
                            <i class="fa fa-edit"></i>
                        </a>
                    </th>
                </tr>
                ...
                <tr>
                    <th scope="col" colspan="2">Data Akademik&nbsp;
                        <a href="index.php?camaba=maba_edit#data_akademik" class="text-secondary">
                            <i class="fa fa-edit"></i>
                        </a>
                    </th>
                </tr>
                ...
                <tr>
                    <th scope="col" colspan="2">Prestasi&nbsp;
                        <a href="index.php?camaba=tambah_prestasi" class="text-secondary">
                            <i class="fa fa-add"></i>
                        </a>
                    </th>
                </tr>
                ...
                ?>
                        <tr>
                            <th scope="row">
                                ...
                                <form action="app/controllers/by_camaba/prestasi.php" method="POST" class="d-inline">
